...
for dataset in datasets:
    ...
    k, t_max, Restarts, fuzzy_degree, q, p_init, p_max, p_step, beta_memory, landa = parameters (dataset, lable_true, col, data)
    ...
    for repeat in range(Restarts):
        ...
        Cluster_elem = main(data, center_points, k, p_init, p_max, p_step, t_max, beta_memory, row, fuzzy_degree, col, q, landa)
        end_time = time.time()
