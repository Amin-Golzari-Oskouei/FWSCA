# This demo shows how to call the Fuzzy clustering with
# the entropy of attribute weights algorithm 
# For the demonstration, the Iris dataset of the above paper is used.
# Courtesy of A.Golzari Oskouei
# Contributors: A.Golzari Oskouei & H.Babaei
...
k, t_max, Restarts, fuzzy_degree, landa =parameters(dataset, lable_true, col , data) 
...
for repeat in range(Restarts):
    ...
    Cluster_elem = main(data, center_points, k, t_max, row, fuzzy_degree, col, landa)
    end_time = time.time()
