# This demo shows how to call the Further improvements in Feature-Weighted Fuzzy C-Means algorithm 
...
k, t_max, Restarts, fuzzy_degree =parameters(dataset, lable_true)
...
for repeat in range(Restarts):
    ...
    Cluster_elem = main(data, center_points, k, t_max, row, fuzzy_degree, col)
    end_time = time.time()
