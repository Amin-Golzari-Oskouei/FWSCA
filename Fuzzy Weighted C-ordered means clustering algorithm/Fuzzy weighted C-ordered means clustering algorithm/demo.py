...
for dataset in datasets:
    ...
    k, t_max, Restarts, fuzzy_degree, q, pa, pk , pm, alpha_type, loss_type = parameters(dataset, lable_true)
    ...
    for repeat in range(Restarts):
        ...
        Cluster_elem = main(data, center_points, k, t_max, row, fuzzy_degree, col, q, pa, pk , pm, alpha_type, loss_type)
        end_time = time.time()
