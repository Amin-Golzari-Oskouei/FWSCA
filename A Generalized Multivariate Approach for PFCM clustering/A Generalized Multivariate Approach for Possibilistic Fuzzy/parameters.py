def parameters(dataset, lable_true):
    ...
    if dataset=='iris':
        ...
        a_coefficient = 1.6           # coefficient of u
        b_coefficient = 0.2           # coefficient of t
        balance_tarm = 2.1 
    elif dataset=='bupa':
        a_coefficient = 1.2           # coefficient of u
        b_coefficient = 0.6          # coefficient of t
        balance_tarm = 1.6 
    elif dataset=='cancer':
        ...
        a_coefficient = 0.4           # coefficient of u
        ...
        b_coefficient = 1.5           # coefficient of t
        balance_tarm = 4.6
    elif dataset=='breast_tissue':
        a_coefficient = 2.1           # coefficient of u
        b_coefficient = 0.7           # coefficient of t
        balance_tarm = 5.1
    elif dataset=='synthetic_global':
        a_coefficient = 2.9           # coefficient of u
        b_coefficient = 0.1           # coefficient of t
        balance_tarm = 0.6
    elif dataset=='vowel':
        a_coefficient = 0.5           # coefficient of u
        ...
        a_coefficient = 3.6          # coefficient of u
        b_coefficient = 2.8           # coefficient of t
        balance_tarm = 3.1
