def object_fun(landa, row, col, k, Cluster_elem, center_points, fuzzy_degree, data, z, delta):
    import numpy as np
    ...
    j_fun3 = landa * np.sum( np.sum (z) * ((1-Cluster_elem) ** fuzzy_degree))
    j_fun  = j_fun1 + j_fun2 + j_fun3
    return j_fun
