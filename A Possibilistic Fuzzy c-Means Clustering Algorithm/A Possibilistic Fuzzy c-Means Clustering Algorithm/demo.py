...
for dataset in datasets:
    ...
    k, t_max, Restarts, fuzzy_degree, T_pow, a_coefficient, b_coefficient, balance_tarm =parameters(dataset, lable_true)
    ...
    for repeat in range(Restarts):
        ...
        Cluster_elem = main(data, center_points, k, t_max, row, fuzzy_degree, col, T_pow, a_coefficient, b_coefficient, balance_tarm)
        end_time = time.time()
