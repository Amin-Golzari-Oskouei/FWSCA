...
for dataset in datasets:
    ...
    k, t_max, Restarts, fuzzy_degree, beta, q, sigma =parameters(dataset, lable_true)
    ...
    for repeat in range(Restarts):
        ...
        Cluster_elem = main(data, center_points, k, t_max, row, fuzzy_degree, col, q, sigma, beta)
        end_time = time.time()
